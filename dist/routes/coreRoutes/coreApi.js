...
router.route('/admin/update/:id').patch(hasPermission(), 
...
router
    ...
    .patch(hasPermission('update'), singleStorageUpload({ entity: 'admin', fieldName: 'photo', fileType: 'image' }), catchErrors(adminController.updateProfile));
...
router
    ...
    .patch(hasPermission(), catchErrors(singleStorageUpload({ entity: 'setting', fieldName: 'settingValue', fileType: 'image' })), catchErrors(settingController.updateBySettingKey));
router
