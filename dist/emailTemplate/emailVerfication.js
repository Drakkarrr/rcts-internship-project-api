export const emailVerfication = ({ title = 'Verify your email', name = '', link = '', time = new Date(), emailToken, }) => {
    return `
    <div>
...
export const passwordVerfication = ({ title = 'Reset your Password', name = '', link = '', time = new Date(), }) => {
    return `
    <div>
...
export const afterRegistrationSuccess = ({ title = 'Verify Your Email Address', name = '', }) => {
    return `
    <div>
